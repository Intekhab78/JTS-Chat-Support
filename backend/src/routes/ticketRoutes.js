...
router.get("/customer-history/:crn", requireRole("admin", "client", "manager", "agent", "sales"), conversionController.getCustomerHistoryByCRN);
router.get("/visitor-history/:sessionId", requireRole("admin", "client", "manager", "agent", "sales"), conversionController.getVisitorHistory);
