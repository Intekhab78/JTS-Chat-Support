...
const customerSchema = new mongoose.Schema(
  {
    ...
    purchaseWorkflowStatus: {
      type: String,
      enum: ["new", "in_review", "quotation_ready", "invoice_ready", "completed"],
      default: "new",
      index: true
    },
    purchaseRequestedAt: { type: Date, default: null },
    purchaseUpdatedAt: { type: Date, default: null },
    purchaseCompletedAt: { type: Date, default: null },
